                    ...
                    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
                        ...
                        if (s != "") {
                            ...
                            if (event == "telemetry") {
                                ...
                                if (changing_lane) {
                                    if ((4*lane)+0.5 < car_d && car_d < (4*lane+4-0.5)) {
                                        changing_lane = false;
                                    }
                                }
                                ...
                                for (int i = 0; i < sensor_fusion.size(); ++i) {
                                    ...
                                    // right lane
                                    if ((4*lane + 4) < d && d < (4*lane+4+4)) {
                                        if ((check_car_s > car_s) && ((check_car_s-car_s) < 50)) {
                                            right_lane_speed = check_speed;
                                        }
                                        if (-40 < (check_car_s-car_s) && (check_car_s-car_s) < 30) {
                                            right_lane_empty = false;
                                        }
                                    }
                                    // left lane
                                    if ((4*lane-4) < d && d < (4*lane)) {
                                        if ((check_car_s > car_s) && ((check_car_s-car_s) < 50)) {
